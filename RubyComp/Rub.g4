...
for_statement : for_header statement_body END ;
              

for_header : FOR id IN (int_result | dynamic_result) TD (int_result | dynamic_result) DO crlf
           | FOR id IN dynamic_result DO crlf
           | LEFT_RBRACKET dynamic_result RIGHT_RBRACKET DOT EACH DO BIT_OR id BIT_OR crlf
           | dynamic_result DOT EACH DO BIT_OR id BIT_OR crlf 
           | LEFT_RBRACKET (int_result | dynamic_result) TD (int_result | dynamic_result) RIGHT_RBRACKET DOT EACH DO BIT_OR id BIT_OR crlf
           ;
...
array_selector : id LEFT_SBRACKET ( int_result | dynamic_result ) RIGHT_SBRACKET
               | LEFT_SBRACKET ( int_result | dynamic_result ) RIGHT_SBRACKET
               ;
...
dynamic_result : dynamic_result op=( MUL | DIV | MOD ) int_result
               ...
               | dynamic_result op=( PLUS | MINUS ) string_result
               | string_result op=( PLUS | MINUS ) dynamic_result
               | int_result op=( PLUS | MINUS ) string_result
               | string_result op=( PLUS | MINUS ) int_result
